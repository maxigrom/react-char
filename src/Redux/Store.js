...
const DEFAULT_MIDDLEWARES = [thunkMiddleware, routerMiddleware(history)];
...
const store = createStore(rootReducerWithHistory, {}, composeEnhancers(applyMiddleware(...getMiddlewares())));
